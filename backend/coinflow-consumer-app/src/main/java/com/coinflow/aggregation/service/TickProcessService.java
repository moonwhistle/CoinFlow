...
public class TickProcessService {
    ...
    private void processFinalizedCandidate(String symbol, ClosedKlineSnapshot snapshot, List<CompletableFuture<Void>> futures) {
    ...
    private void finalizeProcess(String streamKey, String group, RecordId recordId, String symbol, StopWatch sw) {
        ...
        metricRecorder.recordTime(TICK_PROCESS_LATENCY, sw.getTotalTimeMillis(), TAG_MODULE, "consumer", TAG_TYPE, "e2e");
