...
import com.coinflow.aggregation.domain.model.AggregationResult;
import com.coinflow.aggregation.domain.model.ClosedKlineSnapshot;
import com.coinflow.aggregation.domain.service.KlineAggregator;
import com.coinflow.aggregation.infrastructure.adapter.KlineSnapshotBroadcaster;
import com.coinflow.aggregation.infrastructure.adapter.TickerBroadcaster;
...
/**
 * Orchestrates the tick processing pipeline:
 * Ticker broadcasting -> Aggregation -> Snapshot broadcasting -> Persistence -> ACK.
 */
@Service
