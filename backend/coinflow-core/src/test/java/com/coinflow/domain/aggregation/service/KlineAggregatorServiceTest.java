...
class KlineAggregatorServiceTest {
    ...
    void testBucketTransition() {
        ...
        assertAll(
                ...
                () -> assertEquals(0, new BigDecimal("100").compareTo(closedM1.snapshot().close()),
                        "마감 가격은 이전 틱인 100이어야 함"));
    }
    ...
    void testLateTick() {
        ...
        assertAll(
                ...
                () -> assertEquals(0, new BigDecimal("150").compareTo(lateM1.snapshot().high()),
                        "지연 틱에 의해 고가가 150으로 갱신되어야 함"),
